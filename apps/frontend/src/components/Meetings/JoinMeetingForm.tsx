  ...
  return (
    <div className="mt-5 space-y-4">
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-input bg-card px-4 py-3 pr-10 text-sm text-foreground outline-none focus:border-primary"
          />
      ...
      <button
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-medium text-primary-foreground transition hover:brightness-105 disabled:opacity-60"
      >
