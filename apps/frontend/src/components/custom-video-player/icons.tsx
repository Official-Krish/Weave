...
export function CaptionsOffIcon(props: ComponentProps<'svg'>): ReactNode {
...
export function CaptionsOnIcon(props: ComponentProps<'svg'>): ReactNode {
...
export function RestartIcon(props: ComponentProps<'svg'>): ReactNode {
...
export function SeekIcon(props: ComponentProps<'svg'>): ReactNode {
