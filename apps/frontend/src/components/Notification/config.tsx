...
> = {
  ...
  RECORDING_REQUEST_APPROVED: {
    ...
    RECORDING_REQUEST_DENIED: {
        ...
        icon: (
            <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-2.707-7.707a1 1 0 011.414-1.414L10 8.586l2.707-2.707a1 1 0 011.414 1.414L11.414 10l2.707 2.707a1 1 0 01-1.414 1.414L10 11.414l-2.707 2.707a1 1 0 01-1.414-1.414L8.586 10l-2.707-2.707z" clipRule="evenodd" />
            </svg>
        ),
        accent: "text-red-500",
